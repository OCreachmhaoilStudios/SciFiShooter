...
SciFiShooter-Linux-Debug:
	 $(PROJECTBUILD) SciFiShooter Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SciFiShooter-Linux-DebugGame:
	 $(PROJECTBUILD) SciFiShooter Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SciFiShooter-Linux-Shipping:
	 $(PROJECTBUILD) SciFiShooter Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SciFiShooter-Linux-Test:
	 $(PROJECTBUILD) SciFiShooter Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SciFiShooter:
	 $(PROJECTBUILD) SciFiShooter Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SciFiShooterEditor-Linux-Debug:
	 $(PROJECTBUILD) SciFiShooterEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SciFiShooterEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SciFiShooterEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SciFiShooterEditor-Linux-Shipping:
	 $(PROJECTBUILD) SciFiShooterEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SciFiShooterEditor-Linux-Test:
	 $(PROJECTBUILD) SciFiShooterEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SciFiShooterEditor:
	 $(PROJECTBUILD) SciFiShooterEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
